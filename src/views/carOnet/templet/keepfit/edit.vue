<template>
  ...
  center>
    <el-row>
      <el-col>模板名称：<el-input v-model="templatename" placeholder="商品名称" class="w-300" clearable></el-input></el-col>
    </el-row>
...
export default {
  ...
  methods: {
    ...
    async allSubmit() {
      await this.apiPost(this.name, { productList: JSON.stringify(this.form),
